...
public class UpdateFlightComand {
    ...
    public UpdateFlightComand(String flightId, LocalDate departureDate, LocalDate arrivalDate, String origin, String destination,
